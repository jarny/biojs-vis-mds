 ...
 *
 * Supply arbitrary metadata along with the coordinates to allow grouping
...
/**
  ...
  * @param el The root element (usually an empty div) for the visualisation.
...
module.exports.create = (el, opts) => {return new MDSVis(el, opts);};
