...
var MDSVis = function(el, coords, opts) {
  ...
  opts = opts || {};
  this.initDimensions(opts);
  this.initShowLabels(opts);
  this.initData(opts);
  this.initLayoutAndConfig(opts);
  this.initEventHandlers(opts);
};

MDSVis.prototype.initDimensions = function(opts) {
  this.xDim = 1;
  this.yDim = 2;
...
MDSVis.prototype.initShowLabels = function(opts) {
...
MDSVis.prototype.initData = function(opts) {
  this.metadata = {};
...
MDSVis.prototype.initLayoutAndConfig = function(opts) {
...
MDSVis.prototype.initEventHandlers = function(opts) {
